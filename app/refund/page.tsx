      ...
      <main className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-serif font-black text-foreground mb-6">Refund Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="space-y-8 text-muted-foreground leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-serif font-bold text-foreground mb-4">Refund Process</h2>
              ...
              <section>
                <h2 className="text-2xl font-serif font-bold text-foreground mb-4">Refund Timeline</h2>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
