    ...
    <div className="min-h-screen flex bg-[#FFFBF7] dark:bg-background selection:bg-orange-100 dark:selection:bg-primary/30 font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-[#FFF0E6] dark:bg-primary/5 flex-col justify-between p-12 lg:p-20 overflow-hidden">
        ...
        >
          ...
          >
            Shape the future of{" "}
            <span className="text-[#FF9E75] dark:text-primary">Dining.</span>
          </motion.h1>
          ...
          >
            Join 100 students helping us build the fastest way to order food on
            campus. Break the app (gently) and get rewarded.
          </motion.p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center p-6 lg:p-24 overflow-y-auto h-full">
          ...
          {isSuccess ? (
            <div className="flex flex-col items-center justify-center text-center py-12">
              ...
              <p className={`text-lg ${textBody} mb-12 leading-relaxed`}>
                Thanks for helping us build Byte. Keep an eye on your{" "}
                <strong>{formData.email}</strong> inbox. We'll send you a
                download link soon.
              </p>
              <button
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className={`py-4 rounded-[1rem] flex items-center justify-center gap-2 font-black transition-all duration-200 ${
